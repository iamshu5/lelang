...
<section id="table-barang">
    <div class="container-fluid">
        {{-- <div class="d-flex">
            <a href="{{ url('/admin/data/barang') }}"><i class="fas fa-sync-alt"></i> refresh</a>
        </div> --}}
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page"><i class="fa-solid fa-boxes-packing"></i> Data Barang</li>
            </ol>
        </nav>
        {{-- Alert --}}
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header py-3">
                    ...
                    <div class="d-flex justify-content-end">
                        {{-- <button class="btn btn-primary btn-sm shadow-sm mr-2 mt-2" onclick="resfreshTable()"><i class="fas fa-retweet-alt"></i> Refresh Table</button> --}}
                        ...
                        <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img height="80" src="{{ url("assets/admin/image/barang/{$data->foto_barang}") }}"
                                            alt="Foto Barang" class="rounded" id="imgPreview"></td>
                                    ...
                                    <td>- {{ is_object($data->tb_lelang) && $data->tb_lelang->masyarakat ? $data->tb_lelang->masyarakat->nama_masyarakat : '' }}</td>
                                    <td>
                                        <button class="btn btn-warning btn-sm rounded mb-1" data-toggle="modal"
                                            data-target="#editModal{{ $index }}"><i
                                                class="fa-solid fa-pen-to-square"></i></button>
                                        <button class="btn btn-danger btn-sm rounded mb-1 deleteBarangg"
                                                data-id-barang="{{ $data->id_barang }}" data-nama="{{ $data->nama_barang }}"><i
    ...
    <div class="modal fade" id="ModalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/barang/tambah/process') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="col-md-12 mb-2">
                            <img id="preview-image-before-upload" src="" alt="" style="max-height: 300px;">
                        </div>
                        <div class="form-floating mb-3">
                            <label for="">Foto Barang*</label>
                            <input type="file" class="form-control-file @error('foto_barang') is-invalid 
                            @enderror" name="foto_barang" id="foto_barang" value="{{ old('foto_barang') }}"
                        ...
                        <div class="form-floating mb-3">
                            ...
                            @enderror" name="nama_barang" value="{{ old('nama_barang') }}"
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('tanggal') is-invalid 
                            @enderror" name="tanggal" value="{{ old('tanggal') }}" placeholder="Masukan tanggal">
                            @error('tanggal')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-floating mb-3">
                            ...
                            <input type="number" min="0" class="form-control @error('harga_awal') is-invalid 
                            @enderror" name="harga_awal" value="{{ old('harga_awal') }}"
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <textarea name="deskripsi_barang" cols="30" rows="10"
                                ...
                                placeholder="Masukan deskripsi barang">{{ old('deskripsi_barang') }}</textarea>
...
<div class="modal fade" id="editModal{{ $index }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('/admin/barang/edit/' . $data->id_barang) }}" method="POST"
                enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    <div class="form-floating mb-3">
                        <label for="">ID Barang</label>
                        <input type="number" name="id_barang" class="form-control" value="{{ $data->id_barang }}"
                            readonly>
                    </div>
                    <div class="col-md-12 mb-2">
                        <img id="preview-image-before-upload-2" src="" alt="" style="max-height: 300px;">
                    </div>
                    <div class="form-floating mb-3">
                        <label for="">Foto Barang</label>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input type="text" name="nama_barang" class="form-control" value="{{ $data->nama_barang }}"
                            required placeholder="Masukan Nama Barang">
                    </div>
                    <div class="form-floating mb-3">
                    ...
                    <div class="form-floating mb-3">
                        <label for="">Deskripsi Barang</label>
                        <textarea name="deskripsi_barang" class="form-control" cols="30" rows="10"
                            required>{{ $data->deskripsi_barang }}</textarea>
                    </div>
                    <div class="form-floating mb-3">
                        <label for="">Stok Barang</label>
                        <input name="stok" class="form-control" min="0"
...
<script>
    ...
    $('.deleteBarangg').click(function () {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/admin/barang/delete/" + id + ""
